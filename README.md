🌐 Live Demo
Check out the live demo: https://ecosmart-dusky.vercel.app/index.html
...
How It Works:
Search: Type the name of any city in the search bar and press Enter
Instant Results: The app fetches data from OpenWeatherMap API and displays:
...
Visual Feedback: Weather information is presented in an organized card layout with intuitive icons for each metric
🛠️ Technologies Used
...
Start searching for weather information in your favorite cities!
📦 Project Structure
weather-app/
│
